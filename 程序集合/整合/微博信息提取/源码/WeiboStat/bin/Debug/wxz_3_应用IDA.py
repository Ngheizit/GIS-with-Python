...
print("**************主题-词频率分布*************")
lda_model = models.ldamodel.LdaModel(corpus, num_topics=int(sys.argv[4]), id2word=dictionary,  passes=int(sys.argv[3]))#Ö÷ÌâÊý20  µü´ú´ÎÊý200
pprint(lda_model.print_topics(num_topics=int(sys.argv[4]),num_words=int(sys.argv[5])))
